...
export const SUPPORTED_CHAINS: IChainData[] = [
  ...
  },
  {
    ...
    chain_id: 3,
    network_id: 3,
    rpc_url: "https://ropsten.infura.io/v3/f1de7a65620444dea373f1e2f3b636ca",
    native_currency: {
      symbol: "ETH",
      name: "Ether",
      decimals: "18",
  ...
  },
  {
    ...
    chain_id: 4,
    network_id: 4,
    rpc_url: "https://rinkeby.infura.io/v3/f1de7a65620444dea373f1e2f3b636ca",
    native_currency: {
      symbol: "ETH",
      name: "Ether",
      decimals: "18",
  ...
  },
  {
    ...
    chain_id: 5,
    network_id: 5,
    rpc_url: "https://goerli.infura.io/v3/f1de7a65620444dea373f1e2f3b636ca",
    native_currency: {
      symbol: "ETH",
      name: "Ether",
      decimals: "18",
  ...
  },
  {
    ...
    chain_id: 42,
    network_id: 42,
    rpc_url: "https://kovan.infura.io/v3/f1de7a65620444dea373f1e2f3b636ca",
    native_currency: {
      symbol: "ETH",
      name: "Ether",
      decimals: "18",
